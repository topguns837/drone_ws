...
(cl:defmethod battery-val ((m <PlutoPilot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plutodrone-srv:battery-val is deprecated.  Use plutodrone-srv:battery instead.")
  (battery m))
